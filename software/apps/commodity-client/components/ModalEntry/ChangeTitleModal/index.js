...
import XModal from 'appsCommon/components/dom/modals/XModal';
...
class ChangeTitleModal extends Component {
  ...
  render() {
    ...
    return (
      <XModal className="text-input-modal" onClosed={closeModal} opened={true}>
        <div className="text-input-modal-content">
          ...
          <div className="buttons-container">
            {showCancel && (
              <XButton className="white" onClicked={closeModal}>
                {cancelText}
              </XButton>
            )}
            <XButton className="black" onClicked={this.submitText} disabled={!editText.trim()}>
              {confirmText}
            </XButton>
          </div>
        </div>
