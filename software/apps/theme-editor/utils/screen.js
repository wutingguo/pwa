...
import { getSize, getScreenSize } from '@resource/lib/utils/helper';
import { isMobileDevice } from '@resource/lib/utils/mobile';
...
export const getAvailableSize = (pageSize, spreadSize, offset, percent) => {
  ...
  const maxHeight = (pageHeight - (iOffset.top + iOffset.bottom)) * iPercent;
