...
class DeleteStickerModal extends Component {
  ...
  render() {
    ...
    return (
      <div className="delete-modal s-modal" onClick={this.stopPropagation} title="">
        {html ? (
        ...
        <div className="btns">
          <a href="javascript:;" className="btn1" onClick={handleOk}>确定</a>
          <a href="javascript:;" className="btn1 btn1-white" onClick={handleClose}>取消</a>
        </div>
      </div>
    );
  }
