...
async function initProject() {
  ...
  const { default: routes } = await import('@apps/website-tool-client/config/routes');

  // reducer.
  const { default: reducer } = await import('@apps/website-tool-client/redux/reducer');
  ...
  bootstrap(hot(XClientApp), store, 'website-tool-client', appProps);
}
