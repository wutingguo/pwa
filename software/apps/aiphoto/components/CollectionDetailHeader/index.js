...
import mainHandler from '@apps/aiphoto/containers/localization/Collections/List/handle/main';
      ...
      <XButton
        ...
        onClicked={() => {
          ...
          const opt = {
            ...
            callBack: () => this.changeTab(isOriginal, 1),
          };
