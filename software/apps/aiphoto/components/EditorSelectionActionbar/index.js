...
import { XPureComponent, XIcon, XDropdown, XCheckBox } from '@common/components';
...
class EditorSelectionActionbar extends XPureComponent {
  ...
  checkHide = ({ checked }) => {
    const {
      boundProjectActions: { updateCollectionHideRetoucher, handleClearSelectImg }
    } = this.props;
    handleClearSelectImg();
    const eventName = checked
      ? 'AiPhotosCollection_Click_CheckHideRetouched'
      : 'AiPhotosCollection_Click_UncheckHideRetouched';
