...
class GetDirectLinkModal extends XPureComponent {
  ...
  onCopyDirectLink = () => {
    window.logEvent.addPageEvent({
      name: 'SlideshowsShareEmail_Click_GetDirectLinkCopy'
    });
        ...
        <div className="modal-body">
          <div className="copy-link-wrap">
            ...
            <div className="input-with-copy">
              <span className="forward-icon"><XIcon type="link"  iconWidth={16} iconHeight={16} /></span>
              <XInput {...inputProps} />
              <span className="copy-btn" onClick={this.onCopyDirectLink}>{hasCopied ? copiedBtnText : copyBtnText }</span>
            </div>
