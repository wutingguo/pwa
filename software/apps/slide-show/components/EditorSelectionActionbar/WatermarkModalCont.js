...
import {BASE_MODAL} from '@apps/slide-show/constants/modalTypes';
...
class WatermarkModalCont extends XPureComponent {
  ...
  onOk() {
    ...
    window.logEvent.addPageEvent({
      name: 'GalleryChooseWatermark_Click_Save',
  ...
  render() {
    ...
    return (
      <div className="slide-show-watermark-modal-cont-wrapper">
