...
class PostCardPreview extends XPureComponent {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div className="post-card-preview-viewer">
          ...
          <div className="preview-card-content">
            <div className="card-header">
              ...
              <div className="card-detail">
                ...
                <div className="card-address">{studio_address}</div>
              </div>
            </div>
            ...
            <div className="card-introduction">
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: studio_introduction.replace(
