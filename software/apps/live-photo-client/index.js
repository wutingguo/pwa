...
async function initProject() {
  ...
  const { default: routes } = await import('@apps/live-photo-client/config/routes');

  // reducer.
  const { default: reducer } = await import('@apps/live-photo-client/redux/reducer');
  ...
  bootstrap(hot(XClientApp), store, 'live-photo-client', appProps);
}
