      ...
      <div className="collection-share-wrap">
        <div className="share-header">
          <div className="back" onClick={this.onBack}><XIcon type='back' />
            {t('SHARE_BACK_TO_COLLECTION', {collectionName: emailTheme && emailTheme.size ? emailTheme.get('collection_name') : ''})}
          </div>
          <div className="handles">
            <div className="get-link" onClick={this.onGetDirectLink}>
              <XIcon type='link' / >{t('SHARE_GET_DIRECT_LINK')}
            </div>
          </div> 
        </div>
        <div className="share-content-wrap">
          <div className="share-form">
            ...
            <div className="form-item handle-wrap">
              {__isCN__ ? <span></span> : <XCheckBox {...checkboxProps} />}
              <XIcon type="send-invite" theme="black" title="Send Invite" text={t('SHARE_SEND_INVITE')} onClick={this.onSendInvite} />
            </div>
          </div>
          {
