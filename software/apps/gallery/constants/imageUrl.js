...
export const COLLECTION_GALLERY_STYLE_URL_PC = `<%=baseUrl%>clientassets/portal/v2/images/saas/gallery/gallery-style/pc-<%=galleryPhotoName%>.jpg`;
export const COLLECTION_GALLERY_STYLE_URL_M = `<%=baseUrl%>clientassets/portal/v2/images/saas/gallery/gallery-style/m-<%=galleryPhotoName%>.jpg`;
