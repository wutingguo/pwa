...
import * as stateHelper from '@apps/slide-show-client/utils/mapStateHelper';
...
const qs = createSelector(getEnv, data => get(data, 'qs'));
...
const getConvertDetail = createSelector(collection, getUrls, qs, (detail, urls, qs) => {
  return stateHelper.transformDetailData(detail, urls, qs);
});
