...
import { DEFAULT_COVER_URL_SHARE } from '@apps/slide-show-client/constants/imageUrl';
 ...
 * @param {*} urls
 */
const transformDetailData = (data, urls, qs) => {
  ...
  const enc_collection_uid = qs.get('project_id');
