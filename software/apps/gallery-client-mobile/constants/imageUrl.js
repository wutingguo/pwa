...
export const DEFAULT_COVER_URL_SHARE = `<%=saasBaseUrl%>${__isCN__ ? 'clientassets-cunxin-saas' : 'clientassets-zno-saas'}/gallery/default-cover/default-cover-share.jpg`;