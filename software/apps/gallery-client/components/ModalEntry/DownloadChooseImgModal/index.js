      ...
      downloadSets.forEach(set => {
        if (set.set_id === id) {
          const List = data.map(item => {
            set.enc_image_ids.forEach(image_id => {
              if (image_id === item.enc_image_uid) {
  ...
  const selectImageEnv = item => {
    ...
    newSets.forEach(sets => {
      if (sets.set_uid === 'all') {
        ...
        console.log(selected, selectedOldImg, 'selected');
                ...
                >
                  ...
                  {item.isDownload && (
                    <XIcon
                      ...
                      aria-label="Re-downloading this photo will not be counted for the download limit."
                      // title={
