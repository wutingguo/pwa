...
const ShareModal = props => {
  ...
  const showShareMedia = type => {
    ...
    if (type === 'facebook') {
      ...
      // https://www.facebook.com/sharer/sharer.php?u=https://qkjfjrvk.mypixhome.com.t/321321/
      ...
      // https://twitter.com/intent/tweet?url=https://qkjfjrvk.mypixhome.com.t/321321/&text=
    }
  ...
  const onCopy = () => {
    ...
    // const dummy = document.getElementById('copyUrl');
    dummy.value = url;
    dummy.select();
