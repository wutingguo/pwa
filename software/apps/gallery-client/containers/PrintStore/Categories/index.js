...
const Category = ({ category, rackId, history, urls, userImages, user }) => {
  ...
  const handleClick = useCallback(spu => {
    ...
    history.push(
      `/printStore/products?rack_id=${rackId}&sheetCode=${category_code}&spuId=${spu.spu_uuid}&store_spu_id=${spu.id}&product_type=${spu.product_type}`
    );
  });
...
const Categories = props => {
  ...
  return (
    <div className="print-store-page-content-categories">
