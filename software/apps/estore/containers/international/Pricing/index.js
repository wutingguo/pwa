...
class Pricing extends Component {
  ...
  async refreshPageData(rack_spu_id) {
    ...
    try {
      ...
      console.log(
        'rackSkuList: ----------',
        rackSkuList.filter(item => item.sku_uuid === '0AC84E622065402399F30197DA7D4F6C')
      );
                  ...
                  <div className="title-container">
                    <div className="title">
                      ...
                      {rackSpuDetail && rackSpuDetail.default_pages && (
                        <div className="text ">(Default：{rackSpuDetail.default_pages} pages)</div>
                      )}
                    </div>
                    {rackSpuDetail.spu_type == 1 ? (
                      <div className="section-btn" onClick={this.showProductInfoModal}>
                        <div className="icon info" />
                        <div className="text">Product Info</div>
                      </div>
                    ) : null}
                  </div>
                  <div className="info-container">
                    <div className="text title">Fulfillment</div>
                    <div className="info-text text">{fulfillmentText}</div>
                    {rackSpuDetail.spu_type == 1 ? (
                      <div className="info-lab-container">
                        <div className="info-lab text title">Product from the lab</div>
                ...
                {rackSpuDetail.spu_type == 2 ? (
                  <div className="section-container border-bottom extra">
                    ...
                    <span className="text extra">
                      You have full control of the pricing of each extra spread (2 pages). The
                      pricing applies to all albums and books in this price sheet.
                    </span>
                  </div>
                ) : null}
                {/* Pricing Section */}
